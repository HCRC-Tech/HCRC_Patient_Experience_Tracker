...
<section class="container-fluid">
    ...
    <div style="margin-left: -2cm">
        ...
        <div style="margin-left: -10px; margin-top: 60px">
            <ul class="lp">
                <li>
                    <button class="block button button1" onclick="location.href='{{route('/surveyselection')}}'" type="button"><span><img
                ...
                &nbsp;&nbsp;&nbsp;
                <li>
                    <button class="block button button1" onclick="location.href='{{route('/passwordchangepatient')}}'" type="button">
